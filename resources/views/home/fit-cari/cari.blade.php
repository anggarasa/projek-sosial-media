  ...
  <form class="flex items-center max-w-sm mx-auto">   
    ...
    <div class="relative w-full">
        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
          <ion-icon name="person-outline" class="w-4 h-4 text-gray-500 dark:text-gray-400"></ion-icon>
        </div>
  ...
  <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
    <article class="rounded-xl border my-4 border-gray-400 bg-white">
      ...
      <div class="flex justify-center">
        <button type="button" class="px-3 py-2 text-xs font-medium text-center inline-flex border border-black items-center text-black bg-transparent rounded-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-black dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
